  ...
  return <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <TestimonialCard quote="MedBotica helped me understand my symptoms when I couldn't get an immediate doctor's appointment. The information was clear and helped me decide when to seek medical attention." author="Sarah Johnson" role="High School Teacher" rating={5} image="https://images.unsplash.com/photo-1501286353178-1ec881214838?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80" />
            <TestimonialCard quote="As someone with a chronic condition, I often have questions between doctor visits. MedBotica provides reliable information that helps me manage my health better." author="Michael Chen" role="Software Engineer" rating={4} image="https://images.unsplash.com/photo-1535268647677-300dbf3d78d1?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80" />
            <TestimonialCard quote="The conversational interface makes it so easy to get health information. It's like texting with a knowledgeable friend who happens to be a medical expert." author="Emily Rodriguez" role="Marketing Manager" rating={5} image="https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&h=150&q=80" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-medbot-500">
        <div className="container px-4 md:px-6 mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/blog">
              <Button size="lg" variant="outline" className="border-white hover:bg-medbot-600 text-slate-50">
